...
package com.ericsson.tools.cpp.compiler.linux.linking.executables;
...
public class Linux32ExecutableLinker extends AbstractGccExecutableLinker {

	public Linux32ExecutableLinker(final Log log, final CompilationSettings settings, final Environment targetEnvironment, final Executable executable, final DependencyExtractor extractor) {
