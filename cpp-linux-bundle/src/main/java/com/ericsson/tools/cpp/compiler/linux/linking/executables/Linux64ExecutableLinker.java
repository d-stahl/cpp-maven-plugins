...
public class Linux64ExecutableLinker extends AbstractGccExecutableLinker {

	public Linux64ExecutableLinker(final Log log, final CompilationSettings settings, final Environment targetEnvironment, final Executable executable, final DependencyExtractor extractor) {
