...
public class OSX32Compiler extends AbstractGccCompiler {

	public OSX32Compiler(final Log log, final CompilationSettings settings, final Environment targetEnvironment, final RecompilationJudge recompilationJudge) {
